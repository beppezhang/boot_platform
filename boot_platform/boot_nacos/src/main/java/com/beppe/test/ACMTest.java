...
public class ACMTest {
    ...
    public static void main(String[] args) throws ConfigException {
        try {
            ...
            properties.put("namespace", "4a41ca48-b372-4514-b18b-0b229c2b53ba");
            // Access ACM with instance RAM role: https://help.aliyun.com/document_detail/72013.html
            // properties.put("ramRoleName", "$ramRoleName");
            properties.put("accessKey", "LTAI5tAaGudg55se4zMM7HQu");
            properties.put("secretKey", "Vv5jS7lvy7RCO4fEHvoVIjPmmRwvkL");

            ConfigService.init(properties);
            // Get configuration proactively
            String content = ConfigService.getConfig("com.alibaba.cloud.acm:test-demo.properties", "DEFAULT_GROUP", 6000);
            ...
            ConfigService.addListener("com.alibaba.cloud.acm:test-demo.properties", "DEFAULT_GROUP", new ConfigChangeListener() {
            ...
            /**
             ConfigService.addListener("com.alibaba.cloud.acm:test-demo.properties", "DEFAULT_GROUP", new PropertiesListener() {
