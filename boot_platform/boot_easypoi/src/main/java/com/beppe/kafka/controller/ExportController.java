...
import com.beppe.kafka.excel.StudentExcel;
import com.beppe.kafka.util.CSVUtils;
import com.beppe.kafka.util.EasyPoiUtils;
...
public class ExportController {
    ...
    public void export(HttpServletResponse response) throws ClassNotFoundException {
        ...
        EasyPoiUtils.exportExcel(studentExcelList, "标题", "sheetName", Class.forName("com.beppe.kafka.excel.StudentExcel"),
    ...
    public void read(HttpServletResponse response) throws IOException, ClassNotFoundException {
        ...
        EasyPoiUtils.exportExcel(list, "标题", "sheetName", Class.forName("com.beppe.kafka.excel.StudentExcel"),
                "导出文件.xls", true, response);
    }
